  ...
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="signList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="讲师" :show-overflow-tooltip="true" align="center" v-if="columns[3].visible"
                       prop="teacherName"/>
      <el-table-column label="签到人" :show-overflow-tooltip="true" align="center" v-if="columns[4].visible"
                       prop="name"/>
...
<script>
import {listSign, getSign, delSign, addSign, updateSign} from "@/api/manage/sign";
