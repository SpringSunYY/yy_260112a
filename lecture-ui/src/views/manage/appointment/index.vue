  ...
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="appointmentList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="编号" align="center" v-if="columns[0].visible" prop="id" />
        ...
        <el-table-column label="预约描述" :show-overflow-tooltip="true" align="center" v-if="columns[4].visible" prop="appointmentDescription" />
        ...
        <el-table-column label="审核人" :show-overflow-tooltip="true" align="center" v-if="columns[6].visible" prop="auditUserId" />
        <el-table-column label="审核时间" align="center" v-if="columns[7].visible" prop="auditTime" width="180">
        <template slot-scope="scope">
          <span>{{ parseTime(scope.row.auditTime, '{y}-{m}-{d}') }}</span>
        </template>
      </el-table-column>
        <el-table-column label="审核描述" :show-overflow-tooltip="true" align="center" v-if="columns[8].visible" prop="auditDescription" />
        <el-table-column label="备注" :show-overflow-tooltip="true" align="center" v-if="columns[9].visible" prop="remark" />
        <el-table-column label="预约人" :show-overflow-tooltip="true" align="center" v-if="columns[10].visible" prop="userId" />
...
<script>
import { listAppointment, getAppointment, delAppointment, addAppointment, updateAppointment } from "@/api/manage/appointment";
